...
func main() {
	...
	fmt.Println("мне кажется можно только из главной локальной ветки")
	fmt.Println("нет это не так")
	fmt.Println("сейчас попробую из главной локальной в неглавную удаленную")

	fmt.Println("в любом случае не зря сел")
